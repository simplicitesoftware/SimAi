...
Simplicite.UI.ExternalObjects.SaiNewModuleFront = class extends (
    ...
    if (moduleName) {
      ...
      if (available) {
        ...
        app.setChatInteraction();
      	...
      	$ui.toast({type:"error", content:`${$T("SAI_MODULE_NAMEEXIST")}`, position:"top", align:"center", undo:false, moveable:false});
      }
    } else {
      $ui.toast({type:"error", content:`${$T("SAI_MODULE_NONAME")}`, position:"top", align:"center", undo:false, moveable:false});
    }
  }
  ...
  async createModule(app) {
    ...
    if (moduleInfo.error) {
      $ui.toast({type:"error", content:`Error creating module`, position:"top", align:"center", undo:false, moveable:false});
    } else {
  ...
  async prepareJson(app) {
    ...
    try {
      ...
      console.log("error", e);
      $ui.toast({type:"error", content:`Error : JSON isn't valid`, position:"top", align:"center", undo:false, moveable:false});
