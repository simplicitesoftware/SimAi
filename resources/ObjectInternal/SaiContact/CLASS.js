/**
 * JS Class SaiContact with front hooks
 *
 ...
 * @class
 */
Simplicite.UI.BusinessObjects.SaiContact = class extends Simplicite.UI.BusinessObject {
...
onLoadForm(ctn, obj, p) {
	// empty by default
		$('#field_saiContactComment').on('change', function() {
		$ui.saveForm(ctn, obj);
...
}; // class Simplicite.UI.BusinessObjects.SaiContact
