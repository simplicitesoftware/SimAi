/**
 * JS Class SaiInstance with front hooks
 *
 ...
 * @class
 */
Simplicite.UI.BusinessObjects.SaiInstance = class extends Simplicite.UI.BusinessObject {
...
onLoadForm(ctn, obj, p) {
	// empty by default
	//console.log("url: ",obj.getFieldValue("saiInstanceUrl"));
	//window.open(obj.getFieldValue("saiInstanceUrl"), '_blank').focus();
...
}; // class Simplicite.UI.BusinessObjects.SaiInstance